...
export const lang = (language) => dom.create(`
        <div class="w-6/12 sm:w-4/12 lg:w-3/12 p-2 opacity-0 transition-opacity">
            <div aria-label="{name}" class="select-none cursor-pointer p-1 h-full rounded-xl group sm:flex space-x-6 bg-{colour} bg-opacity-75 shadow-xl hover:bg-opacity-100 text-ellipsis overflow-hidden">
