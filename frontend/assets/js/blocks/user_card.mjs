...
export const card = (user) => dom.create(`
        <div class="w-full md:w-6/12 p-2 opacity-0 transition-opacity">
            <div aria-label="{full_name}" onclick="window.location.href = '/users?id={id}'" class="select-none cursor-pointer p-1 h-full rounded-xl group sm:flex space-x-6 bg-slate-900 dark:bg-white dark:bg-opacity-10 bg-opacity-10 shadow-xl hover:bg-opacity-25 text-ellipsis overflow-hidden">
